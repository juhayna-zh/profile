...
const CONFIG = {
  ...
  projects: {
    ...
    external: {
      ...
      projects: [
        {
          title: 'Tencent Song Generation',
          description:
            'The SongGeneration model, developed by Tencent AI Lab, is a language model-based framework for music generation that demonstrates performance comparable to industry-leading solutions such as Suno AI.',
          imageUrl:
            'https://img.freepik.com/premium-vector/seamless-pattern-music-instruments-equipment-electronics-icons_48369-12781.jpg',
          link: 'https://github.com/tencent-ailab/songgeneration',
        },
        {
          title: 'SLAM-LLM',
          description:
  ...
  publications: [
    ...
    },
    {
      ...
      conferenceName: '',
      journalName: '',
      authors: 'Shun Lei, Yaoxun Xu, Zhiwei Lin, Huaicheng Zhang, Wei Tan, Hangting Chen, Jianwei Yu, Yixuan Zhang, Chenyu Yang, <b>Haina Zhu</b>, Shuai Wang, Zhiyong Wu, Dong Yu',
      link: 'https://github.com/tencent-ailab/songgeneration',
      description:
        'We introduce LeVo, an LM-based framework consisting of LeLM and a music codec, achieving vocal-instrument harmony for high-quality song generation.',
    },
    {
